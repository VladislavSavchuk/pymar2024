...
from homework.homework25.page_locators.add_contact_page \
...
class AddContactPage(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.add_contact_btn = AddContactLocators.add_contact_btn
        self.submit_btn = AddContactLocators.submit_btn
        self.cancel_btn = AddContactLocators.cancel_btn
